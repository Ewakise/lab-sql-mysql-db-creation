...
('DAM41UDN3CHU2WVF6', 'Volvo', 'V60 Cross Country', 2019, 'Gray'); -- duplicate VIN for test
...
-- Remember: these IDs (car, customer, salesperson) must match actual IDs from previous inserts
